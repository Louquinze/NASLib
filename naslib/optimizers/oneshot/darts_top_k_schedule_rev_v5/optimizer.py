...
class DARTSScheduledRevOptimizerV5(DARTSOptimizer):
    """
    ...
    def __init__(
        ...
        """
        super(DARTSScheduledRevOptimizerV5, self).__init__(config, op_optimizer, arch_optimizer, loss_criteria)
    ...
    def sample_alphas(edge, epoch, max_epochs):
        ...
        w = np.exp(-0.5 * (((epoch - max_epochs) // 2) ** 2) // (max_epochs // 2))
