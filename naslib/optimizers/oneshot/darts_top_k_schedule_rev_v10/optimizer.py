...
class DARTSScheduledRevOptimizerV10(DARTSOptimizer):
    """
    ...
    def __init__(
        ...
        """
        super(DARTSScheduledRevOptimizerV10, self).__init__(config, op_optimizer, arch_optimizer, loss_criteria)
    ...
    def sample_alphas(edge, epoch, max_epochs):
        ...
        w = np.sin(epoch * (np.pi/max_epochs))
