...
class DARTSScheduledRevOptimizerV7(DARTSOptimizer):
    """
    ...
    def __init__(
        ...
        """
        super(DARTSScheduledRevOptimizerV7, self).__init__(config, op_optimizer, arch_optimizer, loss_criteria)
    ...
    def sample_alphas(edge, epoch, max_epochs):
        ...
        w = np.exp(-(epoch - max_epochs) ** 2 / (max_epochs * 2))
