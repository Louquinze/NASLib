...
class DARTSScheduledRevOptimizerV12(DARTSOptimizer):
    """
    ...
    def __init__(
        ...
        """
        super(DARTSScheduledRevOptimizerV12, self).__init__(config, op_optimizer, arch_optimizer, loss_criteria)
    ...
    def sample_alphas(edge, epoch, max_epochs):
        ...
        w = 0.33 * np.sin(epoch * (np.pi/max_epochs))
