...
class DARTSScheduledRevOptimizerV6(DARTSOptimizer):
    """
    ...
    def __init__(
        ...
        """
        super(DARTSScheduledRevOptimizerV6, self).__init__(config, op_optimizer, arch_optimizer, loss_criteria)
    ...
    def sample_alphas(edge, epoch, max_epochs):
        ...
        w = 0.75 * np.exp(-(epoch - max_epochs / 2) ** 2 / (max_epochs * 2))
