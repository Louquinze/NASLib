...
class DARTSScheduledRevOptimizerV8(DARTSOptimizer):
    """
    ...
    def __init__(
        ...
        """
        super(DARTSScheduledRevOptimizerV8, self).__init__(config, op_optimizer, arch_optimizer, loss_criteria)
    ...
    def sample_alphas(edge, epoch, max_epochs):
        ...
        w = 0.33 * np.exp(-(epoch - max_epochs) ** 2 / (max_epochs * 16))
